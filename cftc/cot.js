...
var formatAllCells = function() {
  $("td[id][value]").each(function(i, d) {
    ...
    if (d.id.indexOf("<span>change:</span>") != -1) {
...
var calculateReport = function(rawReport) {
  var rows = ["positions", "changes", "<span>change:</span>", "traders"],
...
var loadReport = function(date) {
  ...
  $.when($.get(uri + "cot-futures.csv"), $.get(uri + "cot-combined.csv"), $.get(uri + "tff-futures.csv"), $.get(uri + "tff-combined.csv"), this).done(function(cotFutures, cotCombined, tffFutures, tffCombined, self) {
    var reports = {},
      cotHeader =
        //'name,date1,date,CFTC_Code,exchanges,"CFTC_Code_1","CFTC_Code_2",oi_all_total,positions_all_noncom_long,positions_all_noncom_short,positions_all_noncom_spreading,positions_all_com_long,positions_all_com_short,positions_all_total_long,positions_all_total_short,positions_all_nonrep_long,positions_all_nonrep_short,oi_old_total,positions_old_noncom_long,positions_old_noncom_short,positions_old_noncom_spreading,positions_old_com_long,positions_old_com_short,positions_old_total_long,positions_old_total_short,positions_old_nonrep_long,positions_old_nonrep_short,oi_other_total,positions_other_noncom_long,positions_other_noncom_short,positions_other_noncom_spreading,positions_other_com_long,positions_other_com_short,positions_other_total_long,positions_other_total_short,positions_other_nonrep_long,positions_other_nonrep_short,oi_changes,changes_noncom_long,changes_noncom_short,changes_noncom_spreading,changes_com_long,changes_com_short,changes_total_long,changes_total_short,changes_nonrep_long,changes_nonrep_short,oi_all_<span>change:</span>,<span>change:</span>_all_noncom_long,<span>change:</span>_all_noncom_short,<span>change:</span>_all_noncom_spreading,<span>change:</span>_all_com_long,<span>change:</span>_all_com_short,<span>change:</span>_all_<span>change:</span>_long,<span>change:</span>_all_<span>change:</span>_short,<span>change:</span>_all_nonrep_long,<span>change:</span>_all_nonrep_short,oi_old_<span>change:</span>,<span>change:</span>_old_noncom_long,<span>change:</span>_old_noncom_short,<span>change:</span>_old_noncom_spreading,<span>change:</span>_old_com_long,<span>change:</span>_old_com_short,<span>change:</span>_old_<span>change:</span>_long,<span>change:</span>_old_<span>change:</span>_short,<span>change:</span>_old_nonrep_long,<span>change:</span>_old_nonrep_short,oi_other_<span>change:</span>,<span>change:</span>_other_noncom_long,<span>change:</span>_other_noncom_short,<span>change:</span>_other_noncom_spreading,<span>change:</span>_other_com_long,<span>change:</span>_other_com_short,<span>change:</span>_other_<span>change:</span>_long,<span>change:</span>_other_<span>change:</span>_short,<span>change:</span>_other_nonrep_long,<span>change:</span>_other_nonrep_short,oi_all_traders,traders_all_noncom_long,traders_all_noncom_short,traders_all_noncom_spreading,traders_all_com_long,traders_all_com_short,traders_all_traders_long,traders_all_traders_short,oi_old_traders,traders_old_noncom_long,traders_old_noncom_short,traders_old_noncom_spreading,traders_old_com_long,traders_old_com_short,traders_old_traders_long,traders_old_traders_short,oi_other_traders,traders_other_noncom_long,traders_other_noncom_short,traders_other_noncom_spreading,traders_other_com_long,traders_other_com_short,traders_other_traders_long,traders_other_traders_short,"Concentration-Gross LT =4 TDR-Long (All)","Concentration-Gross LT =4 TDR-Short (All)","Concentration-Gross LT =8 TDR-Long (All)","Concentration-Gross LT =8 TDR-Short (All)","Concentration-Net LT =4 TDR-Long (All)","Concentration-Net LT =4 TDR-Short (All)","Concentration-Net LT =8 TDR-Long (All)","Concentration-Net LT =8 TDR-Short (All)","Concentration-Gross LT =4 TDR-Long (Old)","Concentration-Gross LT =4 TDR-Short (Old)","Concentration-Gross LT =8 TDR-Long (Old)","Concentration-Gross LT =8 TDR-Short (Old)","Concentration-Net LT =4 TDR-Long (Old)","Concentration-Net LT =4 TDR-Short (Old)","Concentration-Net LT =8 TDR-Long (Old)","Concentration-Net LT =8 TDR-Short (Old)","Concentration-Gross LT =4 TDR-Long (Other)","Concentration-Gross LT =4 TDR-Short(Other)","Concentration-Gross LT =8 TDR-Long (Other)","Concentration-Gross LT =8 TDR-Short(Other)","Concentration-Net LT =4 TDR-Long (Other)","Concentration-Net LT =4 TDR-Short (Other)","Concentration-Net LT =8 TDR-Long (Other)","Concentration-Net LT =8 TDR-Short (Other)","Contract Units","CFTC Contract Market Code (Quotes)","CFTC Market Code in Initials (Quotes)","CFTC Commodity Code (Quotes)",END',
        'name,date1,date,CFTC_Code,exchanges,"CFTC_Code_1","CFTC_Code_2",oi_total,positions_noncom_long,positions_noncom_short,positions_noncom_spreading,positions_com_long,positions_com_short,positions_total_long,positions_total_short,positions_nonrep_long,positions_nonrep_short,oi_old_total,positions_old_noncom_long,positions_old_noncom_short,positions_old_noncom_spreading,positions_old_com_long,positions_old_com_short,positions_old_total_long,positions_old_total_short,positions_old_nonrep_long,positions_old_nonrep_short,oi_other_total,positions_other_noncom_long,positions_other_noncom_short,positions_other_noncom_spreading,positions_other_com_long,positions_other_com_short,positions_other_total_long,positions_other_total_short,positions_other_nonrep_long,positions_other_nonrep_short,oi_changes,changes_noncom_long,changes_noncom_short,changes_noncom_spreading,changes_com_long,changes_com_short,changes_total_long,changes_total_short,changes_nonrep_long,changes_nonrep_short,oi_<span>change:</span>,<span>change:</span>_noncom_long,<span>change:</span>_noncom_short,<span>change:</span>_noncom_spreading,<span>change:</span>_com_long,<span>change:</span>_com_short,<span>change:</span>_<span>change:</span>_long,<span>change:</span>_<span>change:</span>_short,<span>change:</span>_nonrep_long,<span>change:</span>_nonrep_short,oi_old_<span>change:</span>,<span>change:</span>_old_noncom_long,<span>change:</span>_old_noncom_short,<span>change:</span>_old_noncom_spreading,<span>change:</span>_old_com_long,<span>change:</span>_old_com_short,<span>change:</span>_old_<span>change:</span>_long,<span>change:</span>_old_<span>change:</span>_short,<span>change:</span>_old_nonrep_long,<span>change:</span>_old_nonrep_short,oi_other_<span>change:</span>,<span>change:</span>_other_noncom_long,<span>change:</span>_other_noncom_short,<span>change:</span>_other_noncom_spreading,<span>change:</span>_other_com_long,<span>change:</span>_other_com_short,<span>change:</span>_other_<span>change:</span>_long,<span>change:</span>_other_<span>change:</span>_short,<span>change:</span>_other_nonrep_long,<span>change:</span>_other_nonrep_short,oi_traders,traders_noncom_long,traders_noncom_short,traders_noncom_spreading,traders_com_long,traders_com_short,traders_traders_long,traders_traders_short,oi_old_traders,traders_old_noncom_long,traders_old_noncom_short,traders_old_noncom_spreading,traders_old_com_long,traders_old_com_short,traders_old_traders_long,traders_old_traders_short,oi_other_traders,traders_other_noncom_long,traders_other_noncom_short,traders_other_noncom_spreading,traders_other_com_long,traders_other_com_short,traders_other_traders_long,traders_other_traders_short,"Concentration-Gross LT =4 TDR-Long (All)","Concentration-Gross LT =4 TDR-Short (All)","Concentration-Gross LT =8 TDR-Long (All)","Concentration-Gross LT =8 TDR-Short (All)","Concentration-Net LT =4 TDR-Long (All)","Concentration-Net LT =4 TDR-Short (All)","Concentration-Net LT =8 TDR-Long (All)","Concentration-Net LT =8 TDR-Short (All)","Concentration-Gross LT =4 TDR-Long (Old)","Concentration-Gross LT =4 TDR-Short (Old)","Concentration-Gross LT =8 TDR-Long (Old)","Concentration-Gross LT =8 TDR-Short (Old)","Concentration-Net LT =4 TDR-Long (Old)","Concentration-Net LT =4 TDR-Short (Old)","Concentration-Net LT =8 TDR-Long (Old)","Concentration-Net LT =8 TDR-Short (Old)","Concentration-Gross LT =4 TDR-Long (Other)","Concentration-Gross LT =4 TDR-Short(Other)","Concentration-Gross LT =8 TDR-Long (Other)","Concentration-Gross LT =8 TDR-Short(Other)","Concentration-Net LT =4 TDR-Long (Other)","Concentration-Net LT =4 TDR-Short (Other)","Concentration-Net LT =8 TDR-Long (Other)","Concentration-Net LT =8 TDR-Short (Other)","Contract Units","CFTC Contract Market Code (Quotes)","CFTC Market Code in Initials (Quotes)","CFTC Commodity Code (Quotes)",END',
      tffHeader =
        //'name,date1,date,CFTC_Code,exchanges,"CFTC_Code_1","CFTC_Code_2",oi_total,positions_dealer_long,positions_dealer_short,positions_dealer_spreading,positions_manager_long,positions_manager_short,positions_manager_spreading,positions_funds_long,positions_funds_short,positions_funds_spreading,positions_other_long,positions_other_short,positions_other_spreading,positions_total_long,positions_total_short,positions_nonrep_long,positions_nonrep_short,oi_total_changes,changes_dealer_long,changes_dealer_short,changes_dealer_spreading,changes_manager_long,changes_manager_short,changes_manager_spreading,changes_funds_long,changes_funds_short,changes_funds_spreading,changes_other_long,changes_other_short,changes_other_spreading,changes_total_long,changes_total_short,changes_nonrep_long,changes_nonrep_short,oi_total_<span>change:</span>,<span>change:</span>_dealer_long,<span>change:</span>_dealer_short,<span>change:</span>_dealer_spreading,<span>change:</span>_manager_long,<span>change:</span>_manager_short,<span>change:</span>_manager_spreading,<span>change:</span>_funds_long,<span>change:</span>_funds_short,<span>change:</span>_funds_spreading,<span>change:</span>_other_long,<span>change:</span>_other_short,<span>change:</span>_other_spreading,<span>change:</span>_total_long,<span>change:</span>_total_short,<span>change:</span>_nonrep_long,<span>change:</span>_nonrep_short,total_traders,traders_dealer_long,traders_dealer_short,traders_dealer_spreading,traders_manager_long,traders_manager_short,traders_manager_spreading,traders_funds_long,traders_funds_short,traders_funds_spreading,traders_other_long,traders_other_short,traders_other_spreading,traders_total_long,traders_total_short,<span>change:</span>_gross_held_by_4_or_less_long,<span>change:</span>_gross_held_by_4_or_less_short,<span>change:</span>_gross_held_by_8_or_less_long,<span>change:</span>_gross_held_by_8_or_less_short,<span>change:</span>_net_held_by_4_or_less_long,<span>change:</span>_net_held_by_4_or_less_short,<span>change:</span>_net_held_by_8_or_less_long,<span>change:</span>_net_held_by_8_or_less_short,Contract_Units,"CFTC_Contract_Market_Code_Quotes","CFTC_Market_Code_Quotes","CFTC_Commodity_Code_Quotes","CFTC_SubGroup_Code","FutOnly_or_Combined",END';
